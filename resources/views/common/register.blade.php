...
<form method="POST" action="{{ route('register') }}">
    ...
    <div class="weui-cells weui-cells_form">
        <div class="weui-cell @error('name') weui-cell_warn @enderror">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" name="name" placeholder="身份证姓名一致，填写后不可编辑更改" type="text" value="{{ old('name') }}" required="1">
            </div>
            @error('name')
            <div class="weui-cell__ft">
                <i class="weui-icon-warn"></i>
        ...
        <div class="weui-cell @error('card_id') weui-cell_warn @enderror">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" name="card_id" placeholder="身份证一致，填写后不可编辑更改" type="text" value="{{ old('card_id') }}" required="1">
            </div>
            @error('card_id')
            <div class="weui-cell__ft">
                <i class="weui-icon-warn"></i>
        ...
        <div class="weui-cell @error('wechats') weui-cell_warn @enderror">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" name="wechats" placeholder="请输入微信号" type="text" value="{{ old('wechats') }}" required="1" >
            </div>
            @error('wechats')
            <div class="weui-cell__ft">
                <i class="weui-icon-warn"></i>
        ...
        <div class="weui-cell @error('qq') weui-cell_warn @enderror">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" pattern="[0-15]*" name="qq" placeholder="请输入qq号" type="number" value="{{ old('qq') }}" required="1" >
            </div>
            @error('qq')
            <div class="weui-cell__ft">
                <i class="weui-icon-warn"></i>
        ...
        <div class="weui-cell @error('bank_name') weui-cell_warn @enderror">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" name="bank_name" placeholder="开户银行：例如 建设银行" type="text" value="{{ old('bank_name') }}" required="1" >
            </div>
            @error('bank_name')
            <div class="weui-cell__ft">
                <i class="weui-icon-warn"></i>
        ...
        <div class="weui-cell @error('bank_branch') weui-cell_warn @enderror">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" name="bank_branch" placeholder="开户银行：例如 世纪大道支行" type="text" value="{{ old('bank_branch') }}" required="1" >
            </div>
            @error('bank_branch')
            <div class="weui-cell__ft">
                <i class="weui-icon-warn"></i>
        ...
        <div class="weui-cell @error('bank_no') weui-cell_warn @enderror">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" pattern="[0-18]*" name="bank_no" placeholder="请输入卡号" type="number" value="{{ old('bank_no') }}" required="1" >
            </div>
            @error('bank_no')
            <div class="weui-cell__ft">
                <i class="weui-icon-warn"></i>
